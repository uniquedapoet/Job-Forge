...
const JobSearch = ({ onLogout }) => {
  ...
  const fetchSavedJobIds = async () => {
    ...
    try {
      const response = await fetch(`https://job-forge.ngrok.app/users/${user.id}/saved_jobs`);
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch("https://job-forge.ngrok.app/jobs/job_search", {
        method: "POST",
    ...
    try {
      if (isSaved) {
        const response = await fetch(
          `https://job-forge.ngrok.app/users/${user.id}/saved_jobs/${job.id}/delete`,
          { method: "POST" }
        );
        ...
        const response = await fetch(
          `https://job-forge.ngrok.app/users/${user.id}/saved_jobs/${job.id}/save`,
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
  ...
  const handleJobClick = async (job) => {
    try {
      const response = await fetch(`https://job-forge.ngrok.app/jobs/${job.id}`);
